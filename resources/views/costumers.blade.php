            ...
            <div class="table-responsive bg-color1 ovrflw kundenstyle2" style="overflow: auto; height: 62vh;">
                <table class="table table-borderless bg-white ">
                    ...
                    @if(!$data == [])
                        ...
                        @endphp
                        <tbody id="body-table-edit" onclick="window.location.href='{{route('costumer_form', $datId)}}'" style="cursor: pointer; border: none;border-bottom: 5px #F0F0F0 solid;border-top: 5px #F0F0F0 solid;">
                        <tr>
