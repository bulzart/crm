                                                ...
                                                <div class="accordion-body"
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="societyG" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="number" name="kvg_premiumG" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="provisionG" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control" type="text" name="cidG" id="">
                                                        </div>
                                                ...
                                                <div class="accordion-body"
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="societyV" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="number" name="productionV" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="provisionV" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="cidV" id="">
                                                        </div>
                                                ...
                                                <div class="accordion-body"
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="societyZ" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="number" name="vvg_premiumZ" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="provisionZ" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="cidZ" id="">
                                                        </div>
                                                ...
                                                <div class="accordion-body"
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="societyH" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="number" name="kvg_premiumH" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="provisionH" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="cidH" id="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="accordion-body"
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="productR" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="durationR" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="provisionR" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="cidR" id="">
                                                        </div>
                                                ...
                                                <div class="accordion-body"
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="society_PG" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="product_PG" id="">
                                                        </div>
                                                ...
                                                <div class="accordion-body"
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="society_PZ" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="produkt_PZ" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="vvg_premium_PZ" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="provision_PZ" id="">
                                                        </div>
                                                            <hr>
                                                    </div>
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="produkt_PZ2" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="vvg_premium_PZ2" id="">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="provision_PZ2" id="">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="total_commisions_PZ" id="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="accordion-body"
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="society_PR" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="produkt_PR" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="total_commisions_PR" id="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="accordion-body"
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="society_PV" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="pramie_PV" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="payment_rythm_PV" id="">
                                                        </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="production_PV" id="">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="input-div1 input-groupp justify-content-between">
                                                            ...
                                                            <input class="py-1 form-control " type="text" name="total_commisions_PV" id="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
