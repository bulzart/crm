...
body {font-family: 'Montserrat', sans-serif;}
            ...
            <div class="row mx-4">
              <nav class="g-0">
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                  <button class="nav-link active col krankenkasse-btn" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true" onclick="changecnt(0)">Krankenkasse</button>
                  <button class="nav-link col auto-btn" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false" onclick="changecnt(1)">Auto</button>
                  <button class="nav-link  col sachen-btn" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false" onclick="changecnt(2)">Sachen</button>
                  <button class="nav-link  col vorsorge-btn" id="nav-fourth-tab" data-bs-toggle="tab" data-bs-target="#nav-fourth" type="button" role="tab" aria-controls="nav-fourth" aria-selected="false" onclick="changecnt(3)">Vorsorge</button>
                </div>
              </nav>
            </div>
                      ...
                      <div class="py-2 px-2">
                        ...
                        <div class="upload-box mx-1 my-2">
                          <div class="mx-1 my-2 p-4 text-center">
                            ...
                            <input type="file" name="pre_insurer" value="{{$data->datakk[0]->pre_insurer}}" id="file-input-0" class="svg-div w-100 border-0  g-0" onchange="upload(this)">
                      ...
                      <div class="py-2 px-2">
                        ...
                        <div class="upload-box mx-1 my-2">
                          <div class="mx-1 my-2 p-4 text-center">
                            ...
                            <input type="file" id="file-input-1" class="svg-div w-100 border-0  g-0" onchange="upload(this);" value="{{$data->datakk[0]->id_required}}" name="id_required">
                            <a href="{{Storage::disk('img')->url($data->datakk[0]->id_required)}}"> <input type="text" class="form-control text-center" id="file-input-1c" disabled style="background:none; border:none;" value="{{$data->datakk[0]->id_required}}"></a>
                            @else
                            <input type="file" id="file-input-1" class="svg-div w-100 border-0  g-0" onchange="upload(this);" name="id_required">
                            <input type="text" class="form-control text-center" id="file-input-1c" disabled style="background:none; border:none;">
                            @endif
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="py-2 px-2">
                        ...
                        <div class="upload-box mx-1 my-2">
                          <div class="mx-1 my-2 p-4 text-center">
                            ...
                            <input type="file" id="file-input-2" class="svg-div w-100 border-0  g-0" onchange="upload(this);" name="notice_by" value="{{$data->datakk[0]->notice_by}}">
                            <a href="{{Storage::disk('img')->url($data->datakk[0]->notice_by)}}"><input type="text" class="form-control text-center" id="file-input-2c" disabled style="background:transparent; border:none;" value="{{$data->datakk[0]->notice_by}}"></a>
                            @else
                      ...
                      <div class="py-2 px-2">
                        ...
                        <div class="upload-box mx-1 my-2">
                          <div class="mx-1 my-2 p-4 text-center">
                            ...
                            <input type="file" id="file-input-3" class="svg-div w-100 border-0  g-0" onchange="upload(this);" name="power_of_attorney" value="{{$data->datakk[0]->power_of_attorney}}">
                            <a href="{{Storage::disk('img')->url($data->datakk[0]->power_of_attorney)}}"><input type="text" class="form-control text-center" id="file-input-3c" disabled style="background:transparent; border:none;" value="{{$data->datakk[0]->power_of_attorney}}"></a>
                            @else
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col">
                                        <div class="btn-group w-100" role="group" aria-label="Basic radio toggle button group">
                                          ...
                                          <input type="radio" class="btn-check" value="Ja" name="leasing" id="btnradio1" autocomplete="off" checked>
                                          <label class="btn btn-outline-secondary w-100 g-0" value="Ja" for="btnradio1">Ja</label>
                                          <input type="radio" class="btn-check" value="Nein" name="leasing" id="btnradio1" autocomplete="off">
                                          ...
                                          <label class="btn btn-outline-secondary w-100 g-0" value="Ja" for="btnradio1">Ja</label>
                                          <input type="radio" class="btn-check" value="Nein" name="leasing" id="btnradio1" autocomplete="off" checked>
                                          <label class="btn btn-outline-secondary w-100 g-0" value="Nein" for="btnradio1">Nein</label>
                                          @endif
                                          @else
                                          <input type="radio" class="btn-check" value="Ja" name="leasing" id="btnradio1" autocomplete="off">
                          ...
                          <div class="accordion-body" style="background-color: #EFEFEF !important; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
                            <div class="">
                              ...
                              <div class="my-2">
                                ...
                                <div class="mb-3">
                                  <label for="exampleFormControlTextarea4" class="form-label" style="font-size: 15px;">Gewünschte Zusatzdeckung:</label>
  ...
  <path d="M7.27 1.047a1 1 0 0 1 1.46 0l6.345 6.77c.6.638.146 1.683-.73 1.683H11.5v1a1 1 0 0 1-1 1h-5a1 1 0 0 1-1-1v-1H1.654C.78 9.5.326 8.455.924 7.816L7.27 1.047zM4.5 13.5a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1h-5a1 1 0 0 1-1-1v-1z"/>
                          ...
                          <button class="px-5 py-2" id="submitt1" type="button" style="border: none; border-radius: 9px; background-color:#285F52;" title="Accept">
