...
<div class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 col-xxl-2 d-flex">
    <div class="d-flex navvv" style="height: 100% !important; position: fixed; background-color: #0C71C3;">
        ...
        <div class="nav-itemsss overflow-div1" style="width:100%; background-color: #0C71C3;">
            ...
            <br>
            <div class="">
                <a href="{{route('dashboard')}}" class="nav-link link-dark rounded {{ (request()->is('/')) ? 'activeClassNav__' : '' }}" aria-current="page" style="border-radius: 9px;">
            ...
            @if(Auth::guard('admins')->user()->hasRole('backoffice') || Auth::guard('admins')->user()->hasRole('fs') || Auth::guard('admins')->user()->hasRole('admin'))
                <div class="">
                    <a href="{{route('tasks')}}" class="nav-link link-dark rounded {{ (request()->is('tasks')) ? 'activeClassNav__' : '' }}">
            ...
            @if(Auth::guard('admins')->user()->hasRole('admin') || Auth::guard('admins')->user()->hasRole('fs') || Auth::guard('admins')->user()->hasRole('salesmanager') ||Auth::guard('admins')->user()->hasRole('menagment'))
                <div class="">
                    <a href="{{route('leads')}}" class="nav-link link-dark rounded {{ (request()->is('leads')) ? 'activeClassNav__' : '' }}">
            ...
            @if(Auth::guard('admins')->user()->hasRole('backoffice') || Auth::guard('admins')->user()->hasRole('admin'))
                <div class="">
                    <a href="{{route('status')}}" class="nav-link link-dark rounded {{ (request()->is('status')) ? 'activeClassNav__' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff"
            ...
            @if(Auth::guard('admins')->check())
                <div class="">
                    <a href="{{route('costumers')}}" class="nav-link link-dark rounded {{ (request()->is('costumers')) ? 'activeClassNav__' : '' }}" >
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff"
            ...
            @if(Auth::guard('admins')->user()->hasRole('fs') || Auth::guard('admins')->user()->hasRole('salesmanager') || Auth::guard('admins')->user()->hasRole('menagment') || Auth::guard('admins')->user()->hasRole('admin'))
                ...
                <div class="">
                    <a href="{{route('Appointments')}}" class="nav-link link-dark rounded {{ (request()->is('Appointments')) ? 'activeClassNav__' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff"
                ...
                @else
                    <div class="">
                        <a href="{{route('calendar')}}" class="nav-link link-dark rounded {{ (request()->is('calendar')) ? 'activeClassNav__' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff"
                                 class="bi bi-calendar-check" viewBox="0 0 16 16">
                                <path
                                    d="M10.854 7.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 9.793l2.646-2.647a.5.5 0 0 1 .708 0z" />
    ...
    <!-- <section>
        <div class="nav-section g-0">
            <div class="row g-0">
                <div class="col-">
                    <div class="nav-styling">
                        <div class="" style="height: 8vh;">
                            <div class="my-auto">
                                <div class="img-normal text-center my-auto">
                                    <img src="Logo.png" class="img-fluid" width="150px" alt="">
                                </div>
                                <div class="img-collapsed text-center my-auto">
                                    <img src="Logo gjys.png" class="img-fluid" width="50px" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="nav nav-tabs column-v" id="v-tabs-tab" role="tablist" aria-orientation="vertical">
                            <a class="nav-link active" id="v-tabs-home-tab" data-mdb-toggle="tab" href="#v-tabs-home"
                                ...
                                <span> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                        fill="#fff" class="bi bi-house" viewBox="0 0 16 16">
                                        <path fill-rule="evenodd"
                                            d="M2 13.5V7h1v6.5a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5V7h1v6.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5zm11-11V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z" />
                                        <path fill-rule="evenodd"
                                            d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z" />
                            ...
                            <a class="nav-link" id="v-tabs-tasks-tab" data-mdb-toggle="tab" href="#v-tabs-tasks"
                                role="tab" aria-controls="v-tabs-tasks" aria-selected="false">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff"
                                        class="bi bi-speedometer2" viewBox="0 0 16 16">
                                        <path
                            ...
                            <a class="nav-link" id="v-tabs-leads-tab" data-mdb-toggle="tab" href="#v-tabs-leads"
                                role="tab" aria-controls="v-tabs-leads" aria-selected="false">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff"
                            ...
                            <a class="nav-link" id="v-tabs-finance-tab" data-mdb-toggle="tab" href="#v-tabs-finance"
                                role="tab" aria-controls="v-tabs-finance" aria-selected="false">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff"
                            ...
                            <a class="nav-link" id="v-tabs-status-tab" data-mdb-toggle="tab" href="#v-tabs-status"
                                role="tab" aria-controls="v-tabs-status" aria-selected="false">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff"
                                        class="bi bi-clipboard-data" viewBox="0 0 16 16">
                                        <path
                            ...
                            <a class="nav-link" id="v-tabs-clients-tab" data-mdb-toggle="tab" href="#v-tabs-clients"
                                role="tab" aria-controls="v-tabs-clients" aria-selected="false">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff"
                                        class="bi bi-person-circle" viewBox="0 0 16 16">
                                        <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                                ...
                                <span class="ps-2 txt-dn">Clients</span>
                            </a>
                            <a class="nav-link" id="v-tabs-deposit-tab" data-mdb-toggle="tab" href="#v-tabs-deposit"
                                role="tab" aria-controls="v-tabs-deposit" aria-selected="false">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff"
                            ...
                            <a class="nav-link" id="v-tabs-cancelations-tab" data-mdb-toggle="tab"
                                href="#v-tabs-cancelations" role="tab" aria-controls="v-tabs-cancelations"
                                aria-selected="false">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff"
                            ...
                            <a class="nav-link" id="v-tabs-calendar-tab" data-mdb-toggle="tab" href="#v-tabs-calendar"
                                role="tab" aria-controls="v-tabs-calendar" aria-selected="false">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff"
                                        class="bi bi-calendar-check" viewBox="0 0 16 16">
                                        <path
                                ...
                                <span class="ps-2 txt-dn">
                                    Calendar
                                </span>
                            </a>
                            <a class="nav-link" id="v-tabs-dates-tab" data-mdb-toggle="tab" href="#v-tabs-dates"
                                role="tab" aria-controls="v-tabs-dates" aria-selected="false">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff"
                                        class="bi bi-calendar-date" viewBox="0 0 16 16">
                                        <path
                            ...
                            <a class="nav-link" id="v-tabs-employees-tab" data-mdb-toggle="tab" href="#v-tabs-employees"
                                role="tab" aria-controls="v-tabs-employees" aria-selected="false">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff"
                            ...
                            <a class="nav-link" id="v-tabs-prov.system-tab" data-mdb-toggle="tab"
                                href="#v-tabs-prov.system" role="tab" aria-controls="v-tabs-prov.system"
                                aria-selected="false">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff"
                                        class="bi bi-diagram-2-fill" viewBox="0 0 16 16">
                        ...
                        <div class="log-out-div col-2">
                            <hr class="hr-1 m-0">
                            <div class="logg d-flex justify-content-center">
                                <button class=" btn">
                                    <span class="">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19"
                                            fill="#fff" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd"
                                    ...
                                    <span class="ps-2 txt-dn"> Log out</span>
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    <style>
        ...
        @media (max-width: 999.98px) {
            ...
            .nav-tabs .nav-link:hover .txt-dn {
                display: flex;
