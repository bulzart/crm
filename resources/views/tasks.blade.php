                ...
                <div style="background: #f7f7f7; border-radius: 25px; padding: 5%;">
                    <div class="row">
                        <div class="col-12" style="cursor: pointer;" id="Offene_Aufgaben__">
                            <span>Offene Aufgaben <span class="text-danger">{{$opencnt}}</span> <i
                                    id="Offene_Aufgaben_arrow__" style="color: #ababab; float: right;"
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <nav role="navigation" aria-label="Pagination Navigation"
                                            ...
                                            @if($tasks->currentPage() > 1)
                                                <span>
                                                    <a
                                                        href="{{route('tasks',['page' => $tasks->currentPage() -1 ])}}"
                                            ...
                                            @endif
                                            « Previous
                                            <a href="{{route('tasks',['page' => $tasks->currentPage() +1])}}"
                                                       class="relative inline-flex items-center px-4 py-2 ml-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 rounded-md hover:text-gray-500 focus:outline-none focus:ring ring-gray-300 focus:border-blue-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">
                                                Next »
                                            </a>
                                    </div>
                ...
                <div style="background: #ffebe5; border-radius: 25px; padding: 5%;">
                    <div class="row">
                        <div class="col-12" style="cursor: pointer;" id="Pending__">
                            <span>Pending <span class="text-danger">{{count($pending)}}</span> <i id="Pending_arrow__"
                                                                                                  style="color: #ff9b7d; float: right;"
                                                                                                  class="bi bi-caret-down-fill"></i></span>
                        </div>
                    </div>
                    <br>
