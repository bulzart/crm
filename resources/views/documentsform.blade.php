                    ...
                    <div class="py-2 px-2">
                      ...
                      <div class="upload-box mx-1 my-2">
                        <div class="mx-1 my-2 p-4 text-center">
                          ...
                          <input type="file" name="id_required" id="file-input-3" class="svg-div w-100 border-0  g-0">
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="py-2 px-2">
                      ...
                      <div class="upload-box mx-1 my-2">
                        <div class="mx-1 my-2 p-4 text-center">
                          ...
                          <input type="file" name="notice_by" id="file-input-3" class="svg-div w-100 border-0  g-0">
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="py-2 px-2">
                      ...
                      <div class="upload-box mx-1 my-2">
                        <div class="mx-1 my-2 p-4 text-center">
                          ...
                          <input type="file" name="power_of_attorney" id="file-input-3" class="svg-div w-100 border-0  g-0">
                        </div>
                      </div>
                    </div>
                  </div>
                            ...
                            <div class="">
                              <div class="upload-box mx-1 my-2">
                                <div class="mx-1 my-2 p-4 text-center">
                                  ...
                                  <input type="file" name="upload_police" id="file-input-3" class="svg-div w-100 border-0  g-0">
                                </div>
                              </div>
                            </div>
                            <div class="">
                                  ...
                                  <div class="">
                                    ...
                                    <div class="upload-box mx-1 my-2">
                                      <div class="mx-1 my-2 p-4 text-center">
                                        ...
                                        <input name="redeemed" type="file" id="file-input-3" class="svg-div w-100 border-0  g-0">
                                      </div>
                                    </div>
                                  </div>
                                </div>
                            ...
                            <div class="">
                              <div class="upload-box mx-1 my-2">
                                <div class="mx-1 my-2 p-4 text-center">
                                  ...
                                  <input name="upload_police__" type="file" id="file-input-3" class="svg-div w-100 border-0  g-0">
                                </div>
                              </div>
                            </div>
                            <div class="">
