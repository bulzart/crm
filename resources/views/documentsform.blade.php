            ...
            <div>
                ...
                <div>
                    ...
                    <select name="employmentrelationship">
                        @if(isset($data->employmentrelationship)) <option selected value="{{$data->employmentrelationship}}">{{$data->employmentrelationship}}</option> @endif
                ...
                <div>
                    ...
                    <select name="paymentrhythm">
                        @if(isset($data->paymentrhythm))<option selected value="{{$data->paymentrhythm}}">{{$data->paymentrhythm}}</option>@endif
