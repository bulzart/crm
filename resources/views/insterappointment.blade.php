        ...
        <div class="form">
            ...
            <div class="col-12">
                <div class="card-details">
                    ...
                    <div class="input-group">
                        <div class="input"> <input type="number" name="postal" class="col-12 form-control" placeholder="Postal code" required="required"></div>
                        ...
                        <div class="input"> <input type="number" name="count" class="col-12 form-control" placeholder="People included" required="required"> </div>
                    </div>
                    <div class="input-group">
                    <div class="input"><span class="mb-2">Meeting way</span>
                    <br><select onchange="hideadmin()" name="online" id="selecti" class="form-control"><option value="yes">Online</option><option value="no">Physically</option>  </select></div>
</div>
<div class="input-group">
