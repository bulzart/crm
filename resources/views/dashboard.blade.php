        ...
        <nav class="nav">
            <div>
                <div class="nav_list">
                    ...
                    @if(Auth::guard('admins')->user()->role == 'backoffice' ||  Auth::guard('admins')->user()->role == 'admin') <a href="#" style="text-decoration: none;" class="nav_link"><i class='bx bxs-wallet'></i><span class="nav_name">Deposit</span> </a> @endif
                    ...
                    @if(Auth::guard('admins')->user()->role == 'admin' || Auth::guard('admins')->user()->role == 'menagment' || Auth::guard('admins')->user()->role == 'salesmenager')<a href="#" style="text-decoration: none;" class="nav_link"><i class="far fa-calendar-alt"></i><span class="nav_name">Dates</span> </a>@endif
...
<notifications></notifications>
    ...
    <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 col-12">
    <h3>Overview</h3>
    <div class="col-12">
Completed
    <div class="progress">
