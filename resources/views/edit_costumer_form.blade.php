                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " type="text" name="societyG" id="" value="{{$grundversicherung->societyG}}">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " type="number" name="kvg_premiumG" value="{{$grundversicherung->kvg_premiumG}}" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$grundversicherung->provisionG}}" type="text" name="provisionG" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control" value="{{$grundversicherung->cidG}}" type="text" name="cidG" id="">
                                                            </div>
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$vorsorge->societyV}}" type="text" name="societyV" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$vorsorge->productionV}}" type="number" name="productionV" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$vorsorge->provisionV}}" type="text" name="provisionV" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$vorsorge->cidV}}" type="text" name="cidV" id="">
                                                            </div>
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$zusatzversicherung->societyZ}}" type="text" name="societyZ" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$zusatzversicherung->vvg_premiumZ}}" type="number" name="vvg_premiumZ" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$zusatzversicherung->provisionZ}}" type="text" name="provisionZ" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$zusatzversicherung->cidZ}}" type="text" name="cidZ" id="">
                                                            </div>
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$hausrat->societyH}}" type="text" name="societyH" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$hausrat->kvg_premiumH}}" type="number" name="kvg_premiumH" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$hausrat->provisionH}}" type="text" name="provisionH" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$hausrat->cidH}}" type="text" name="cidH" id="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$retchsschutz->productR}}" type="text" name="productR" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$retchsschutz->durationR}}" type="text" name="durationR" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$retchsschutz->provisionR}}" type="text" name="provisionR" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$retchsschutz->cidR}}" type="text" name="cidR" id="">
                                                            </div>
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$grundversicherungP->society_PG}}" type="text" name="society_PG" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$grundversicherungP->product_PG}}" type="text" name="product_PG" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$grundversicherungP->total_commisions_PG}}" type="text" name="total_commisions_PG" id="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$zusatzversicherungP->society_PZ}}" type="text" name="society_PZ" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$zusatzversicherungP->produkt_PZ}}" type="text" name="produkt_PZ" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$zusatzversicherungP->vvg_premium_PZ}}"  type="text" name="vvg_premium_PZ" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$zusatzversicherungP->provision_PZ}}" type="text" name="provision_PZ" id="">
                                                            </div>
                                                            <hr>
                                                        </div>
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$zusatzversicherungP->produkt_PZ2}}" type="text" name="produkt_PZ2" id="">
                                                            </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$zusatzversicherungP->vvg_premium_PZ2}}" type="text" name="vvg_premium_PZ2" id="">
                                                            </div>
                                                        </div>
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$zusatzversicherungP->provision_PZ2}}" type="text" name="provision_PZ2" id="">
                                                            </div>
                                                        </div>
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$zusatzversicherungP->total_commisions_PZ}}" type="text" name="total_commisions_PZ" id="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$retchsschutzP->total_commisions_PR}}" type="text" name="total_commisions_PR" id="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="mb-3">
                                                            <div class="input-div1 input-groupp justify-content-between">
                                                                ...
                                                                <input class="py-1 form-control " value="{{$vorsorgeP->total_commisions_PV}}" type="text" name="total_commisions_PV" id="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
