        ...
        <div class="mt-2 mb-2 calendar-divider">
            ...
            <div class="col-12 row text-center my-2">
                <div class="col-6 col-md-6 g-0" style="color: #4CC590">
                    <i @click="searchfor()" class="dateee px-1 pb-1"
                       style="cursor:pointer; border-radius: 50px !important;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                             class="bi bi-chevron-left fw-bold" viewBox="0 0 16 16">
                ...
                <div class="col-6 col-md-6" style="color: #4CC590">
                    <i class="dateee px-1 pb-1" style=" cursor:pointer; border-radius: 50px !important;"
                       @click="searchfor2()">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                             class="bi bi-chevron-right fw-bold" viewBox="0 0 16 16">
                            <path fill-rule="evenodd"
            ...
            <div class="mt-1 scroll-2" style="height: 250px; overflow-y: scroll; overflow-x:hidden !important;">
                ...
                <a style="text-decoration: none" v-if="today != null" v-for="tod in today"
                   :href="'acceptappointment/'+tod.id">
