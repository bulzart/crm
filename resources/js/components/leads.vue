    ...
    <div class="appointments-sm-div">
      <div class="row pt-4 pb-2">
        <div class="col-5 header-title g-0">
          <div class="text-start ps-5">
            <span class="fw-600 text-color fs-5"> Leads </span>
          </div>
        </div>
        <div class="col appointment-filter my-auto text-end g-0 pe-5"></div>
      </div>
      <div class="appointments-content py-3">
        ...
        >
          <div class="row mx-1">
            <div
              class="col-6 col-xs-6 col-sm-6 col-md-4 col-lg-6 g-0"
              v-for="lead in leads"
            >
              <div
                class="modal fade"
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <select class="form-control" name="reason">
                          ...
                          <option value="Hat schon gewechselt">
                            Hat schon gewechselt
                          </option>
                          <option value="Kein interesse">Kein interesse</option>
                          <option value="Krank">Krank</option>
                          <option value="Kunde bereits terminiert">
                            Kunde bereits terminiert
                          </option>
                          <option value="Nicht Brauchbar">
                            Nicht Brauchbar
                          </option>
              ...
              <div class="row">
                ...
                <div class="col ps-0">
                  ...
                  >
                    <div class="row mx-2">
                      ...
                      >
                        <div class="text-center">
                          ...
                          <span>Adresse: {{ lead.address }}</span
                          ><br />
                          <span
                            >Haushalt:
                            {{ lead.number_of_persons }} Personen </span
                          ><br />
                    ...
                    <div
                      style="background: #b8b8b8; border-radius: 15px"
                          ...
                          <div class="modal-body">
                            <div class="">
                              <div class="container pb-5">
                                ...
                                <hr />
                                <div
                                  class="row mx-4 text-dark text-center"
                                ...
                                <div
                                  class="row mx-4 text-dark text-center mt-2"
                                  style="border-radius: 15px; background: white"
                                >
                                  <h5>Herkunft vom Lead</h5>

                                  <span>
                                    Gerburstdatum:{{ lead.birthdate }}</span
                                  >
                                  <span
                                    >Haushalt: {{ lead.number_of_persons }}
                                  </span>
                                  <span>Telefon: {{ lead.telephone }}</span>
                                  <span
                                    >PLZ,Ort: {{ lead.postal_code }},{{
                                      lead.city
                                    }}
                                  </span>
                                  <span
                                    >Krankenkasse: {{ lead.krankenkasse }}
                                  </span>
                                  <span
                                    >Bewertung KK: {{ lead.bewertung }}
                                  </span>
